...
import { List, Button, Switch, Card, Title, Paragraph, IconButton, TextInput } from 'react-native-paper';
...
const allRewards = [
  {
    ...
    url: 'https://static1.squarespace.com/static/5d890dc76001c32118d9c7f7/t/5e0143ae9bb1cd38ee77d5b1/1613515544775/?format=1500w',
    points: 120,
  },
  {
    name: 'Sweetberries',
    description: 'Free medium create your own icecream',
    url: 'https://sweetberries.com/wp-content/uploads/2010/08/logo_oval2_big.png',
    points: 180
  },
  {
  ...
  },    
  {
    ...
    url: 'https://lh3.googleusercontent.com/fNlfR27CeNWPi8gHTZduTj4dU-z-HjEyEZISe2vvoAwHe1BRpKekcxSh2MDbj5pH97QRarWlFKxndgRXCaqoXfS_kwVasFAapjMfOuZy=s340',
    points: 200
  },
  {
    name: 'Opus Coffee',
    description: 'One free medium iced coffee',
    url: 'https://static1.squarespace.com/static/55f862a7e4b09ee1e2fc39c4/t/57fb8461c534a5767ea97af7/1614283302053/',
    points: 100
  }
]
...
export default class DashboardScr extends React.Component{
  ...
  claimReward = (image) => {
    ...
    this.setState({rewards: [...this.userRewards],points: this.state.points-image.points,userRewardsModalVisible:false});
  }
  ...
  render(){
  const {dailySwitch, weeklySwitch, monthlySwitch,userRewardsModalVisible, settingsModalVisible, QRModalVisible, rewards, points, username,password} = this.state;
  ...
  return (
    ...
    >
      ...
      <View style={styles.streak}>
        <Text style={styles.streakText}>Budget Goal Streak: 7 weeks!</Text>
      </View>
      ...
      {rewards.length > 0 ?
        ...
        <View style={{margin:20}}>
          <Text style={{alignSelf:'center',fontSize:20}}>You haven't claimed any rewards yet</Text>
          <Text style={{alignSelf:'center',fontSize:20,marginTop:10}}>Hit budget goals, earn points, get rewards!</Text>
        </View>
      }
      </View>
      <Modal
      ...
      >
        <View style={styles.centeredView}>
          <View style={styles.modalView}>
             <Text style={styles.modalText}>You have {points} points!</Text>
             <View style={{width, height:200, marginLeft:75}}>
                  <ScrollView
                    pagingEnabled horizontal style={{width:300,height}} centerContent
                  >
                    {
              ...
              <Button
                ...
                onPress={() => this.setState({userRewardsModalVisible: false})}
              >
      ...
      >
        <View style={styles.centeredView}>
          <View style={[styles.modalView,{height:'80%'}]}>
            ...
            <View style={{paddingTop: 10,width:'95%',backgroundColor:'white'}}>
              <Paragraph style={{color:'#4B674C',fontSize:20,marginLeft:15,fontWeight:'bold'}}>Account Info</Paragraph>
              <TextInput
                label="Username"
                value={username}
              ...
              <TextInput
                ...
                theme={{colors: {primary: '#5B5B5B'}}}
              />
              <Paragraph style={{color:'#4B674C',fontSize:20,marginLeft:15,fontWeight:'bold'}}>Notifications</Paragraph>
              <List.Section>
                  <List.Item title="Daily" titleStyle={{fontSize:17}} style={{backgroundColor:'#ffffff'}} right={props => <Switch value={dailySwitch} onValueChange={this.toggleDaily} color={'#4B674C'}/>}/>
                  <List.Item title="Weekly" titleStyle={{fontSize:17}} style={{backgroundColor:'#ffffff'}} right={props => <Switch value={weeklySwitch} onValueChange={this.toggleWeekly} color={'#4B674C'}/>}/>
                  <List.Item title="Monthly" titleStyle={{fontSize:17}} style={{backgroundColor:'#ffffff'}} right={props => <Switch value={monthlySwitch} onValueChange={this.toggleMonthly} color={'#4B674C'}/>}/>
              </List.Section>
            </View>
            ...
            <Button
                mode="contained"
                uppercase={false}
                style={[styles.modalButton,{width:'40%',marginLeft:50,marginRight:20}]}
              ...
              <Button
                mode="contained"
                uppercase={false}
                style={[styles.modalButton,{width:'40%',marginRight:50,marginLeft:20}]}
      ...
      >
        <View style={styles.centeredView}>
          <View style={styles.modalView}>
             ...
             <Text style={[styles.modalText,{fontSize:20,fontWeight:'normal'}]}>Or Use Pin: AX7D32Q</Text>
              <Button
                mode="contained"
                uppercase={false}
